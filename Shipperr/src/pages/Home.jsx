...
const [showSignup, setShowSignup] = useState(false);
  ...
  <div className="flex items-center gap-3">
    <img src="/logo.png" alt="Shipperr Logo" className="w-10 h-10 object-contain" />
    <h1 className="text-2xl font-extrabold text-blue-700 tracking-wide">
      <Link to="/"> Shipperr </Link>
    </h1>
  </div>
    ...
    >
      ...
      <section className="py-20 px-6 bg-white border-t border-gray-200">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-10 text-gray-800">Why Choose Shipper ?</h2>
  ...
  <div className="max-w-4xl mx-auto">
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        {/* Company */}
        <div>
          <h3 className="font-semibold text-blue-700 text-lg mb-3">Shipper</h3>
          <p className="text-gray-600">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="mailto:support@shipsecure.com" className="hover:text-blue-500">support@Shipper.com</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4 mt-4 text-blue-700 text-xl">
            ...
            <a href="https://www.linkedin.com/in/radhe-tailor-088252251/"><FaLinkedin className="hover:text-blue-600" /></a>
          </div>
        </div>
      </div>
      ...
      <div className="text-center py-5 border-t border-blue-100 bg-blue-100 text-gray-600">
        © {new Date().getFullYear()} <span className="font-semibold text-blue-700">Shipper</span> by Radhe | All rights reserved.
      </div>
    </footer>
